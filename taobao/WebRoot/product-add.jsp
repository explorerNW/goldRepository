			...
			<form action="AddProduct.action" method="post">
				<table class="form">
					<tr>
						...
						<td><input type="text" class="text" name="ep_name" /></td>
					</tr>
					
					
					<tr>
						<td class="field">商品价格：</td>
						<td><input type="text" class="text tiny" name="ep_price" /> 元</td>
					</tr>
					<tr>
						<td class="field">品牌：</td>
						<td><input type="text" class="text" name="ep_description" /></td>
					</tr>
					<tr>
						<td class="field">库存：</td>
						<td><input type="text" class="text tiny" name="ep_stock" /></td>
					</tr>
					<tr>
						<td class="field">条码号：</td>
						<td><input type="text" class="text" name="ep_file_name" /></td>
					</tr>
					<tr>
						<td></td>
