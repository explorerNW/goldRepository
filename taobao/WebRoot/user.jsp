...
<%@page import = "com.easyBuy.hz.bean.User" %>
			...
			<table class="list">
			    ...
			    <!-- <%
			          for(int i = 0;i<userList.size();i++){
			        	           %>
			        	                 <tr>
				        	                 <td><%=userList.get(i).getEn_user_id() %></td>
				        	                 <td><%=userList.get(i).getEn_user_name() %></td>
				        	                 <td><%=userList.get(i).getEn_user_sex() %></td>				     
				        	                 <td><%=userList.get(i).getEn_address() %></td>
				        	                 <td><%=userList.get(i).getEn_mobile() %></td>
			        	                     <td><%=userList.get(i).getEn_status() %></td>
			        	                 </tr>
			        	           <%
			          }
			    %>
