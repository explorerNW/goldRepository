			...
			<form action="userInsert.do" method="post">
				...
				<table class="form">
					<tr>
						...
						<td><input type="text" class="text" name="userId" value="" /></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><input type="radio" name="euSex" value="1" checked="checked" />男 <input type="radio" name="sex" value="1" />女</td>
					</tr>
					...
					<tr>
						...
						<td><input type="text" class="text" name="euEmail" value="" /></td>
					</tr>
