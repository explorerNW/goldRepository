$(function() {
  function h() {
    ...
    function g(a) {
      switch(a) {
      case 6:
        $(".index_push_designer,.index_push_jobs").width(600), $(".index_push_experience").width(580)
      }
    }
    var c = $(window).width(),
    ...
    case 5:
      ...
      break;
    case 6:
      $(".upmenu,.login ul,.nav ul").show(), $(".sc3").nMR(), $(".listbox").hMR(), $(".login").removeClass("logintoggle"), $("#header").removeClass("ogrid"), g(ueI)
    }(function() {
      for(i = 1; i <= d / ueI; i++) {
  ...
  $(".newlist .likeit,.morewebsite .likeit,.nsmall .likeit").click(function() {
    if($(".openlogin").length) return $(".openlogin a").click(), !1;
  ...
  $("#index_list_round").hover(function() {
    ...
    if(!c) return $(".index_list_arrow_prev").addClass("index_list_cur"), $(".index_list_arrow_next").addClass("index_list_cur"), $(".index_list_info").stop().css("bottom", - 70), !1;
  ...
  $("#postbtn.sitemessage").click(function(a) {
    ...
    if(!a.title) return alert("\u540d\u5b57\u4e0d\u80fd\u4e3a\u7a7a"), !1;
    a.email = $.trim($("#youremail").val());
    if(!a.email) return alert("\u90ae\u7bb1\u4e0d\u80fd\u4e3a\u7a7a"), !1;
    if(!/^[\w\.\-\+]+@([\w\-]+\.)+[a-z]{2,4}$/i.test(a.email)) return alert("\u90ae\u7bb1\u683c\u5f0f\u4e0d\u6b63\u786e"), !1;
    a.content = $.trim($("#yourcontent").val());
    if(!a.content) return alert("\u5185\u5bb9\u4e0d\u80fd\u4e3a\u7a7a"), !1;
